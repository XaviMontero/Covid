        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          onTap: (index) {
            Navigator.pushReplacement(
                context, MaterialPageRoute(builder: (context) => HomePage(contra: contry.buscarContry(),)));
          },
        ),
